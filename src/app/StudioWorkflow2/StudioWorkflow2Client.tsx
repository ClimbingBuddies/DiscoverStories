...
type Episode = {
  ...
  summary: string | null; episode_status: string; word_count: number | null;
  artwork_url: string | null; artwork_path: string | null;
};
type PlanningBlock = {
  id: string; season_number: number; block_number: number; episode_start: number;
  episode_end: number; title: string; arc_summary: string | null; content_status: string;
};
