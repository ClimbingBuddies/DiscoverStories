      ...
      <div className="mx-auto flex max-w-4xl flex-col gap-8 overflow-hidden">
        <div className="flex flex-col gap-4 rounded-[2rem] border border-zinc-800 bg-zinc-900 p-6 sm:p-8">
          ...
          {storyVoices && storyVoices.length > 0 ? (
            <div className="rounded-[1.5rem] border border-zinc-700/40 bg-zinc-950/60 p-4 sm:p-5">
              <div className="mb-3">
                <p className="text-sm font-semibold text-white">Text-to-speech (Quick Play)</p>
                <p className="text-sm text-zinc-400">No audio file? Use your browser&apos;s built-in voices instead.</p>
              </div>
              <QuickPlayPlayer
